...
import org.opengis.cite.swecommon20.ErrorMessage;
import org.opengis.cite.swecommon20.ErrorMessageKeys;
...
public class Capability1Tests {
     ...
     * {@link org.opengis.cite.swecommon20.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/swecommon20/rnc/atom.rnc");
