...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tns="http://www.opengis.net/cite/swecommon20"
  xmlns:saxon="http://saxon.sf.net/"
  xmlns:tec="java:com.occamlab.te.TECore"
  xmlns:tng="java:org.opengis.cite.swecommon20.TestNGController">

  <ctl:function name="tns:run-ets-swecommon20">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the swecommon20 ${version} test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:suite name="tns:ets-swecommon20-${version}">
     <ctl:title>Test suite: ets-swecommon20</ctl:title>
	  ...
	  <ctl:code>
        <xsl:variable name="form-data">
           <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
             <h2>Test suite: ets-swecommon20</h2>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-swecommon20">
